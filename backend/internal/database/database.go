...
WITH seed(parent_code, type, code, name, path, component, icon, sort_order) AS (
  VALUES
    ...
    ('business', 'page', 'complex-form:view', '复杂表单示例', '/business/complex-forms', 'ComplexFormPage', 'FormOutlined', 22),
    ('business', 'page', 'code-generator:view', '快速生成代码', '/business/code-generator', 'CodeGeneratorPage', 'CodeOutlined', 23),
    ...
    ('collaboration', 'page', 'notification:view', '公告中心', '/collaboration/announcements', 'AnnouncementCenterPage', 'BellOutlined', 31),
    ...
    ('menu:view', 'button', 'menu:create', '创建菜单', NULL, NULL, NULL, 131),
    ('menu:view', 'button', 'menu:update', '编辑菜单', NULL, NULL, NULL, 132),
    ('menu:view', 'button', 'menu:delete', '删除菜单', NULL, NULL, NULL, 133),
    ...
    ('complex-form:view', 'button', 'complex-form:create', '创建复杂表单', NULL, NULL, NULL, 221),
    ('complex-form:view', 'button', 'complex-form:update', '编辑复杂表单', NULL, NULL, NULL, 222),
    ('complex-form:view', 'button', 'complex-form:delete', '删除复杂表单', NULL, NULL, NULL, 223),
    ('code-generator:view', 'button', 'code-generator:create', '生成代码', NULL, NULL, NULL, 231),
    ...
    ('notification:view', 'button', 'notification:create', '创建公告', NULL, NULL, NULL, 501),
