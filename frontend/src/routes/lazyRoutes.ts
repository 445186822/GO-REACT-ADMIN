...
export const enterpriseRoutes: EnterpriseRoute[] = [
  ...
  { path: 'business/code-generator',    permission: 'code-generator:view',  loader: page(() => import('../features/codegen/pages/CodeGeneratorPage'), 'CodeGeneratorPage') },
  ...
  { path: 'collaboration/announcements', permission: 'notification:view',   loader: page(() => import('../features/collaboration/pages/AnnouncementCenterPage'), 'AnnouncementCenterPage') },
